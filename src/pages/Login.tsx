        ...
        <div className="glass-card p-8 space-y-6">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <Input type="email" placeholder="Email address" className="pl-10 h-11 rounded-xl" />
            </div>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
              <Input type={showPassword ? "text" : "password"} placeholder="Password" className="pl-10 pr-10 h-11 rounded-xl" />
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link to="#" className="text-primary hover:underline font-medium">Forgot password?</Link>
          </div>

          <Link to="/dashboard">
            <Button className="w-full btn-gradient h-11 text-sm">Sign in</Button>
          </Link>
        </div>
