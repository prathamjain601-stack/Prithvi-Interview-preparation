...
type TestPhase = "setup" | "test" | "result";
      ...
      <DashboardLayout>
        <div className="max-w-2xl mx-auto space-y-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Configure and start your assessment.</p>
          </div>
    ...
    return (
      <DashboardLayout>
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <Button className="w-full btn-gradient h-12 text-sm" onClick={() => { setPhase("setup"); setAnswers(Array(questions.length).fill(null)); setCurrent(0); }}>
            Take Another Test
          </Button>
        </div>
      </DashboardLayout>
